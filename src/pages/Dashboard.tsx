...
const Dashboard: React.FC = () => {
  ...
  }, [addSkill, initializeShop, isAuthenticated, refreshDailyQuests, skills.length, updateUser, user.lastActive, user.streak]);
  ...
  return (
    <Layout currentPage="dashboard">
      ...
      >
        ...
        >
          {domains.map((domain) => {
            const progress = domainProgressData[domain];
            return (
            <motion.div
              key={domain}
              variants={{
