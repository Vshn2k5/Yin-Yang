              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setLearningPrefs({ ...learningPrefs, learningStyle: e.target.value as LearningPreferences['learningStyle'] })}
                    className="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white"
                    disabled={!isEditing}
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setAccountabilitySettings({
                      ...
                      checkInFrequency: e.target.value as AccountabilitySettings['checkInFrequency']
                    })}
                    className="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white"
                    disabled={!isEditing}
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setCommunicationPrefs({
                      ...communicationPrefs,
                      reminderStyle: e.target.value as CommunicationPreferences['reminderStyle']
                    })}
                    className="w-full bg-gray-700 border border-gray-600 rounded px-3 py-2 text-white"
                    disabled={!isEditing}
                  >
