...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ 
  ...
  // If the user is authenticated (real Supabase session), they are at minimum a 'user',
  // even if the profile fetch failed and authUser.profile.role is undefined.
  const userRole = authUser?.profile?.role || (isAuthenticated ? 'user' : 'guest');
